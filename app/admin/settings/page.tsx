        ...
        <Card className="border-border">
          <CardHeader className="p-6 pb-3">
            <div className="flex items-center justify-between">
              ...
              {isDbLive ? (
                <Badge variant="success" className="text-xs gap-1 font-mono">
                  <CheckCircle2 className="h-3 w-3" /> Neon Live PG Connected
                </Badge>
              ) : (
                <Badge variant="outline" className="text-xs gap-1 font-mono border-amber-500/30 text-amber-600 dark:text-amber-400">
          ...
          <CardHeader className="p-6 pb-3">
            <div className="flex items-center justify-between">
              ...
              {isRazorpayConfigured ? (
                ...
                <Badge variant="outline" className="text-xs gap-1 font-mono border-sky-500/30 text-sky-600 dark:text-sky-400">
